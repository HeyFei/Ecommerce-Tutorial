...
import Img04 from "../assets/images/img-1.jpg";
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="banner-frame"><img className="img-fluid" src={aboutImg} alt=""/>
                            </div>
                        </div>
                        <div className="col-lg-6">
                    ...
                    <div className="row my-4">
                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="hover-team">
                                <div className="our-team"><img src={Img01} alt=""/>
                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="hover-team">
                                <div className="our-team"><img src={Img02} alt=""/>
                                    <div className="team-content">
                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="hover-team">
                                <div className="our-team"><img src={Img03} alt=""/>
                                    <div className="team-content">
                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="hover-team">
                                <div className="our-team"><img src={Img04} alt=""/>
                                    <div className="team-content">
                                        <h3 className="title">Williamson</h3> <span
                                        className="post">Web Developer</span></div>
                                    <ul className="social">
