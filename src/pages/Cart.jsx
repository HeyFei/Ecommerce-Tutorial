            ...
            <div className="cart-box-main">
                <div className="container">
                    ...
                    <div className="row my-5">
                        ...
                        <div className="col-12 d-flex shopping-box"><a href="checkout.html"
                                                                       className="ml-auto btn hvr-hover">Checkout</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    return (
        <tr>
            ...
            <td className="quantity-box">
                ...
                <input style={{width: "50%"}} type="text" value={quantity || 0} readOnly size="4" min="0" step="1"
